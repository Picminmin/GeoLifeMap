...
if __name__ == "__main__":
    """
    国別の出生時平均寿命をグラデーションで表すアニメーションgifを生成する。
    ・実行方法
    </> bat(.\.venv\Scripts\activateコマンドでvenvを有効にしてください)
    python -m src.tiny_map_gif
    ・gif → mp4にする方法
    </> bat
    ffmpeg -i life_expectancy_2000_2021.gif -vf "fps=24,setpts=7*PTS" -movflags +faststart -pix_fmt yuv420p life_expectancy_2000_2021_2min.mp4
    """
    main()
